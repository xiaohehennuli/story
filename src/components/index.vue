    ...
    <loader :loading="loading">
      ...
      <template slot="body">
        ...
        <el-image
          ...
          v-once
          lazy
          src="https://www.bing.com/th/id/OIP.PRADmIq6xBky7Vynsl6hrgHaHL?w=210&h=204&c=7&r=0&o=5&pid=1.7"
          fit="cover"
        >
          <div
            slot="error"
...
export default {
  ...
  mounted() {
    setTimeout(() => {
      this.push = this.$common.pushNotification(
        this.$store.state.webInfo.notices,
        false
      );
